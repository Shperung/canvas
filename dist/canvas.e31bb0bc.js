...
var c11 = function c11() {
  ...
  intreval = setInterval(function () {
    var timePassed = Date.now() - start; //https://github.com/finnursig/VideoScroller/blob/master/src/EasingFunctions.js

    if (timePassed < duration * 3) {
      ctx.clearRect(0, 0, canvas.width, canvas.height);
      var t = timePassed / duration;
      var t5 = timePassed / duration;
      var t6 = timePassed / duration; // без easing, без прискорення

      var x1 = t * 400; // прискорення з нульової швидкості

      var x2 = Math.pow(t, 2) * 400; // тройне прискорення з нульової швидкості

      var x3 = Math.pow(t, 3) * 400; // уповільнення до нульової швидкості

      var x4 = t * (2 - t) * 400; //прискорення до півдороги, потім уповільнення

      var x5 = (t5 < .5 ? 2 * t5 * t5 : -1 + (4 - 2 * t5) * t5) * 400; // уповільнення до нульової швидкості

      var x6 = (--t6 * t6 * t6 + 1) * 400; // рух по різних функціях
...
var _default = c11;
exports.default = _default;
},{}],"c12.js":[function(require,module,exports) {
"use strict";
...
var _c12 = _interopRequireDefault(require("./c12"));
...
(0, _c11.default)();
(0, _c12.default)();
},{"./c1":"c1.js","./c2":"c2.js","./c3":"c3.js","./c4":"c4.js","./c5":"c5.js","./c6":"c6.js","./c7":"c7.js","./c8":"c8.js","./c9":"c9.js","./c10":"c10.js","./c11":"c11.js","./c12":"c12.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
